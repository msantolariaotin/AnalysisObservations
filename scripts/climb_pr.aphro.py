...
ds= xr.open_dataset(sourceData+data+'/'+fileName)[variable]
...
clevsStd=np.arange(0,1.5,0.1)#infoplot.get('levels_std')

clevsT=np.arange(-0.6,0.7,0.1)#infoplot.get('levels_diff')
